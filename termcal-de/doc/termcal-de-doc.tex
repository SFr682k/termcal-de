...
\begin{document}
	...
	\medskip
	% TODO: URL für termcal--Paketdokumentation einfügen
	\texttt{termcal-de} only adds a German localization to the \texttt{termcal} package. Please read the \href{URL}{\texttt{termcal} documentation} first, because the macros stay almost identical. The differences to plain \texttt{termcal} are listed in section \ref{differences}.
